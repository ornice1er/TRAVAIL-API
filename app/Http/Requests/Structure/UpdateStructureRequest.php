...
class UpdateStructureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'job' => 'nullable|string',
            'acronym' => 'sometimes|required|string|max:191',
            'slug' => 'sometimes|required|string|max:191|unique:structures,slug,' . $this->route('structure'),
            ...
            'type_structure_id' => 'sometimes|required|exists:types_structures,id',
